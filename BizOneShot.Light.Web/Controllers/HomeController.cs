...
namespace BizOneShot.Light.Web.Controllers
{
    ...
    public class HomeController : BaseController
    {
        ...
        public HomeController(IScUsrService scUsrService, IPostService _postService, IScCompInfoService _scCompInfoService, IMServiceDomainService mServiceDomainService)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel loginViewModel)
        {
            ...
            ScUsr scUsr = await _scUsrService.SelectScUsr(loginViewModel.ID.Trim());
            if (scUsr != null)
            {
                //패스워드비교
                SHACryptography sha2 = new SHACryptography();
