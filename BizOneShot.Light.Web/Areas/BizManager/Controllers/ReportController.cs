...
namespace BizOneShot.Light.Web.Areas.BizManager.Controllers
{
    ...
    public class ReportController : BaseController
    {
        ...
        public async Task<ActionResult> TotalCompCount(string bizWorkSn, string bizWorkNm, int year, int curPage = 1)
        {
            ...
            var listScCompInfoMapping = await _scCompMappingService.GetCompMappingInfoPagedListByMentorIdForMng(int.Parse(bizWorkSn), "A", year, curPage, pageSize);

            var comListViews = Mapper.Map<List<JoinCompanyViewModel>>(listScCompInfoMapping);
