...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    ...
    internal partial class QuesCompInfoConfiguration : EntityTypeConfiguration<QuesCompInfo>
    {
        ...
        public QuesCompInfoConfiguration(string schema)
        {
            ...
            Property(x => x.MarketEtcText).HasColumnName("MARKET_ETC_TEXT").IsOptional().HasColumnType("nvarchar").HasMaxLength(255);
            Property(x => x.ResidentEtcText).HasColumnName("RESIDENT_ETC_TEXT").IsOptional().HasColumnType("nvarchar").HasMaxLength(255);
            Property(x => x.CertiEtcText).HasColumnName("CERTI_ETC_TEXT").IsOptional().HasColumnType("nvarchar").HasMaxLength(255);
            Property(x => x.StandardCode1).HasColumnName("STANDARD_CODE1").IsOptional().HasColumnType("nvarchar").HasMaxLength(5);
            Property(x => x.StandardCode2).HasColumnName("STANDARD_CODE2").IsOptional().HasColumnType("nvarchar").HasMaxLength(5);
            Property(x => x.StandardCode3).HasColumnName("STANDARD_CODE3").IsOptional().HasColumnType("nvarchar").HasMaxLength(5);
            Property(x => x.MainSellMarket).HasColumnName("MAIN_SELL_MARKET").IsOptional().HasColumnType("nvarchar").HasMaxLength(255);
