...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    public interface IWebDbContext : IDisposable
    {
        ...
        DbSet<JibunPostCdD> JibunPostCdDs { get; set; } // JIBUN_POST_CD__D
        ...
        DbSet<RptPageView> RptPageViews { get; set; } // RPT_PAGE_VIEW
        DbSet<RptStatusView> RptStatusViews { get; set; } // RPT_STATUS_VIEW
