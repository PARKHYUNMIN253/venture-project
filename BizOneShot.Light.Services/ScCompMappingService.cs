...
namespace BizOneShot.Light.Services
{
    public interface IScCompMappingService : IBaseService
    {
        ...
        Task<IPagedList<RptStatusView>> GetCompMappingInfoPagedListByMentorId(int bizworkSn, string mentorId, string status, int year, int page, int pageSize);
        Task<IPagedList<RptStatusView>> GetCompMappingInfoPagedListByMentorIdForMng(int bizworkSn, string status, int year, int page, int pageSize);

        Task<IPagedList<RptStatusView>> GetCompMappingInfoPagedListByMentorId(int bizworkSn, string mentorId, string status, int page, int pageSize);
    }
    ...
    public class ScCompMappingService : IScCompMappingService
    {
        ...
        public async Task<IPagedList<RptStatusView>> GetCompMappingInfoPagedListByMentorId(int bizworkSn, string mentorId, string status, int year, int page, int pageSize)
        {
            return await scCompMappingRepository.GetPagedListCompMappingInfoAync(bizworkSn, mentorId, status, year, page, pageSize);
        }
        //GetPagedListCompMappingInfoAyncForMng
        public async Task<IPagedList<RptStatusView>> GetCompMappingInfoPagedListByMentorIdForMng(int bizworkSn, string status, int year, int page, int pageSize)
        {
            return await scCompMappingRepository.GetPagedListCompMappingInfoAyncForMng(bizworkSn, status, year, page, pageSize);
        }

        public async Task<IPagedList<RptStatusView>> GetCompMappingInfoPagedListByMentorId(int bizworkSn, string mentorId, string status, int page, int pageSize)
        {
            return await scCompMappingRepository.GetPagedListCompMappingInfoAync(bizworkSn, mentorId, status, page, pageSize);
        }
